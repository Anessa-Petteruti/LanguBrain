...
//  LangBrain
//
//  Created by Anessa Petteruti on 06/18/19.
...
class GoogleTranslate : NSObject {
    ...
    func translateTextTask(text: String, sourceLanguage: String, targetLanguage: String, completionHandler: @escaping (String?, Error? ) -> Swift.Void) throws -> URLSessionDataTask {
        ...
        urlComponents.queryItems    = [
            URLQueryItem(name: "key"  , value: "AIzaSyBZGN-g4UtAngr_z3YNgu09pLNkaRrg2l4") 
        ]
