...
class Step2: UIViewController {
    ...
    @IBAction func backButton(_ sender: Any) {
        performSegue(withIdentifier: "backToHelp2", sender: self)
    }
    ...
    override func viewDidLoad() {
        ...
        step2.layer.shadowColor = UIColor.gray.cgColor
        step2.layer.shadowOffset = CGSize(width: 2.0, height: 2.0)
        step2.layer.shadowOpacity = 0.5
        step2.layer.shadowRadius = 1.0
        step2.clipsToBounds = false
