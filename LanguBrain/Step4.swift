...
class Step4: UIViewController {
    ...
    @IBAction func backButton(_ sender: Any) {
        performSegue(withIdentifier: "backToHelp4", sender: self)
    }
    override func viewDidLoad() {
        ...
        step4.layer.shadowColor = UIColor.gray.cgColor
        step4.layer.shadowOffset = CGSize(width: 2.0, height: 2.0)
        step4.layer.shadowOpacity = 0.5
        step4.layer.shadowRadius = 1.0
        step4.clipsToBounds = false
