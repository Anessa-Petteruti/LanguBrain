...
class Step5: UIViewController {
    ...
    @IBAction func backButton(_ sender: Any) {
        performSegue(withIdentifier: "backToHelp5", sender: self)
    }
    override func viewDidLoad() {
        ...
        step5.layer.shadowColor = UIColor.gray.cgColor
        step5.layer.shadowOffset = CGSize(width: 2.0, height: 2.0)
        step5.layer.shadowOpacity = 0.5
        step5.layer.shadowRadius = 1.0
        step5.clipsToBounds = false
